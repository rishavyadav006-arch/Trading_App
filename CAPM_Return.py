...
try:
    ...
    for i in stocks_daily_return.columns:
        ...
        # Ignoring the date and S&P500 Column
        if i != 'Date' and i != 'sp500':

                # calculate beta and alpha for all stock
    ...
    for stock, beta_value in beta.items():
        ...
        # calculate return
        stock_return = rf + (beta_value * (rm-rf))
        return_value.append(str(round(stock_return * 100, 2)) + '%')
